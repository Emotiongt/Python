...
class Window:
    def __init__(self):
        ...
        self.mstatus=tkinter.IntVar()           #是否批量转换
        self.fstatus=tkinter.IntVar()           #是否改变文件格式
        self.pstatus=tkinter.IntVar()           #logo的位置(0,1,2,3)
        self.Image.set('bmp')
        self.mstatus.set(0)
        self.fstatus.set(0)
        self.pstatus.set(0)
        ...
        self.rRT=tkinter.Radiobutton(pframe,variable=self.pstatus,value=1,text='右上角')
        self.rRT.pack(anchor='w')
        self.rLB=tkinter.Radiobutton(pframe,variable=self.pstatus,value=2,text='左下角')
        self.rLB.pack(anchor='w')
        self.rRB=tkinter.Radiobutton(pframe,variable=self.pstatus,value=3,text='右下角')
    ...
    def addlogo(self,file,f=None):
        ...
        if f:
            im.save(file[:(len(file)-4)]+'_logo.'+f)
        else:
